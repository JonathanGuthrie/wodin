...
ImapServer::ImapServer(uint32_t bind_address, short bind_port, SessionFactory *factory, std::string fqdn, unsigned login_timeout, unsigned idle_timeout, unsigned asynchronous_event_time, unsigned bad_login_pause) throw(ServerErrorException)
{
  ...
  for (int i=0; i<FD_SETSIZE; ++i)
    {
      m_sessions[i] = new SessionDriver(this, m_pipeFd[1], factory);
    }
